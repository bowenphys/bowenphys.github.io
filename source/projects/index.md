...
<section class="lab-record-card">
  ...
  <p>变分量子本征求解器开发工具包，包含多种ansatz设计、错误缓解策略和优化器接口。支持Qiskit、Cirq和PennyLane后端。</p>
...
<section class="lab-record-card">
  ...
  <p>Wannier90后处理工具箱，实现二次谐波产生(SHG)、Berry曲率和反常霍尔效应的自动计算。支持多种TMDC材料的批量处理。</p>
